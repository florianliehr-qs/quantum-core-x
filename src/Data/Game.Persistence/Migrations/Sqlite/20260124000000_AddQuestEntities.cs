    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                QuestName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                StateIndex = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                IsStarted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false,
                    defaultValueSql: "current_timestamp"),
                QuestDataId = table.Column<Guid>(type: "TEXT", nullable: false),
